...
<h4 class="text-light">এডিট বায়োডাটা {{ $auth->name}},</h4>
...
{{-- <li class="nav-item ">
<a class="nav-link " id="tab-9-tab" data-toggle="pill" href="#tab-9" role="tab" aria-controls="tab-9" aria-selected="true">IOM তথ্য</a>
</li> --}}
<li class="nav-item">
...
<input type="text" class="form-control" onfocusout="handle_birth_day(this);"  name="date_of_birth" id="date_of_birth" value="@if($primary_info != null) {{$primary_info->date_of_birth}} @endif" placeholder = "yyyy-mm-dd">
...
<form  name="iom_info">
    <?php 
        //  $iom_info =  App\Models\iom_info::where(['user_table_id'=>$auth->id])->first();
          ?>
    
<div class="card mb-3 class" data-condtion id="id">
<div class="card-body">
<div class="form-group">
<label for="সম্পূর্ণ নাম" class="font-weight-bold">সম্পূর্ণ নাম <span class="text-mute">(Required)</span></label>
<input type="text" class="form-control"  name="full_name" value="@if($iom_info != null) {{$iom_info->full_name}} @endif" placeholder="সম্পূর্ণ নাম" required>
<input type="hidden" class="form-control"  name="t_name" value="iom_info"  required>
...
<div class="card-body">
<div class="form-group">
<label for="আপনি কি আইওএমের স্টুডেন্ট?" class="font-weight-bold">আপনি কি আইওএমের স্টুডেন্ট? </label>
<select class="form-control" name="is_iom_student"   placeholder="আপনি কি আইওএমের স্টুডেন্ট?">
<option value>Select</option>
<option value="1" @if($iom_info != null)  @if($iom_info->is_iom_student=="1") {{"Selected"}} @endif @endif>হ্যা</option>
<option value="0" @if($iom_info != null)  @if($iom_info->is_iom_student=="0") {{"Selected"}} @endif @endif >না</option>
</select>

</div>
</div>
</div>
<div class="card mb-3 class12" data-condtion="12" id="id14">
<div class="card-body">
<div class="form-group">
<label for="আপনার রোল নম্বর:" class="font-weight-bold">আপনার রোল নম্বর: </label>
<input type="text" class="form-control"name="roll_no" value="@if($iom_info != null) {{$iom_info->roll_no}} @endif"  placeholder="আপনার রোল নম্বর:">
...
<div class="card-body">
<div class="form-group">
<label for="আপনার কোর্সের নাম ও  ব্যাচ নম্বর:" class="font-weight-bold">আপনার কোর্সের নাম ও ব্যাচ নম্বর: </label>
<input type="text" class="form-control"  name="course_and_batch_no" value="@if($iom_info != null)  {{$iom_info->course_and_batch_no}} @endif"  placeholder="আপনার কোর্সের নাম ও  ব্যাচ নম্বর:">
...
<input type="text" class="form-control"  name="number_visible_authority"  value=" @if($communication != null ) {{$communication->number_visible_authority}} @endif"   placeholder="আপনার নাম্বার (শুধুমাত্র আপনি ও কতৃপক্ষ বাদে কেউ দেখতে পাচ্ছে না) *" required />
...
<li><a href="{{URL::to("/is_permition_for_public")}}" id="publish_btn"  class="d-none btn btn-warning btn-sm bg-info">বায়োডাটা পাবলিশ করুন</a></li>
